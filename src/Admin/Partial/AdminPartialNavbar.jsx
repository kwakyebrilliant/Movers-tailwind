...
import { FaBook, FaBuilding, FaMailBulk } from 'react-icons/fa'
  ...
  return (
    <nav className='bg-white shadow-sm border-gray-200 mx-2 px-2 py-2.5 rounded'>
            ...
            <ul className={!nav ? 'hidden' : 'absolute bg-zinc-900 w-fit px-8'}>
                ...
                <li className='border-zinc-900 w-fit text-white'><Link to="/adminbooked" className='flex' onClick={handleClose}><FaBook className='text-2xl mr-4' />Booked</Link></li>
...
export default AdminPartialNavbar