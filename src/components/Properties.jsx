...
const Properties = () => {
              ...
              <div className="flex overflow-x-scroll hide-scroll-bar">
                ...
                <div className="flex flex-nowrap lg:ml-6 md:ml-20 py-4 ml-6">
                  ...
                  <div className="inline-block text-center px-3">
                    <div className="w-64 cursor-pointer h-64 max-w-xs bg-green-800  overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out">
                  ...
                  <div className="inline-block text-center px-3">
                    <div className="w-64 cursor-pointer h-64 max-w-xs bg-blue-800 overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out">
                  ...
                  <div className="inline-block text-center px-3">
                    <div className="w-64 h-64 cursor-pointer max-w-xs bg-red-700 overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out">
                  ...
                  <div className="inline-block text-center px-3">
                    <div className="w-64 h-64 cursor-pointer max-w-xs bg-yellow-700 overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out">
                        <p className='text-6xl flex mt-20 justify-center font-bold text-white'>
                  ...
                  <div className="inline-block text-center px-3">
                    <div className="w-64 h-64 max-w-xs cursor-pointer bg-white overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out">
  ...
  <div className="max-w-screen-xl px-4 py-12 mx-auto sm:px-6 lg:px-8">
    ...
    <div className="lg:sticky lg:top-4">
      ...
      >
        {/* <summary className="flex items-center justify-between px-5 py-3 bg-gray-900 lg:hidden">
